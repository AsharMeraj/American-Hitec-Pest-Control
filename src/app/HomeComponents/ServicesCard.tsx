  ...
  return (
    <section className='grid grid-rows-[auto,auto] shadow-xl shadow-black/5 rounded-t-[1rem]'>
      <main className='relative'>
        ...
        <Image alt='' src={icon} width={100} height={100} className='absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-full' />
      </main>
      <main className='h-fit'>
        <h2 className='text-2xl font-semibold w-full text-center mt-12'>{name}</h2>
