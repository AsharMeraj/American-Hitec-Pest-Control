                ...
                <div className='w-[70rem] mx-4 sm:mx-10 flex items-center justify-between'>
                    ...
                    <div>
                        <div id='namebox' className='hidden md:flex items-center justify-between gap-2 min-[900px]:gap-4 lg:gap-7'>
                            ...
                            <Link href='/Services' className='names cursor-pointer text-sm lg:text-base hover:text-[--Secondary] transition-all font-semibold text-black tracking-wide '>
                                <h2>Services</h2>
                            </Link>
                            <Link href='/Personal' className='names cursor-pointer text-sm lg:text-base hover:text-[--Secondary] transition-all font-semibold text-black tracking-wide '>
                                <h2>Personal</h2>
                            </Link>
                            <Link href='/Contact' className='names cursor-pointer text-sm lg:text-base hover:text-[--Secondary] transition-all font-semibold text-black tracking-wide '>
                                <h2>Contact</h2>
                            </Link>
                        </div>
                    </div>
